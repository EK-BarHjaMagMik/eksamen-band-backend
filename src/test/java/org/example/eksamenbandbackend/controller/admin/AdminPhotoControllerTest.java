...
class AdminPhotoControllerTest {
        ...
        void batchUpdatePhotos_returnsUpdatedPhotosOnSuccess() throws Exception {
                PhotoResponse r1 = new PhotoResponse(1L, "/uploads/1.jpg", "Cap1", LocalDate.of(2026, 5, 1), "P1",
                                null);
                PhotoResponse r2 = new PhotoResponse(2L, "/uploads/2.jpg", "Cap2", LocalDate.of(2026, 5, 2), "P2",
                                null);
